...
public enum HtmlElement {
    FIRST_NAME("First Name", "input_1_1", "field_1_1"),
    LAST_NAME("Last Name", "input_1_10", "field_1_10"),
    COMPANY("Company", "input_1_2", "field_1_2"),
    POSITION("Position", "input_1_3", "field_1_3"),
    ADDRESS("Address", "input_1_4", "field_1_4"),
    POSTCODE("Postcode", "input_1_5", "field_1_5"),
    EMAIL("Email", "input_1_9", "field_1_9"),
    PHONE_NUMBER("Phone No", "input_1_7", "field_1_7"),
    CONTACT_US_SUBMIT("Submit", "gform_submit_button_1", ""),
    NATURE_OF_ENQUIRY("Nature of your enquiry", "input_1_8", "field_1_8");
